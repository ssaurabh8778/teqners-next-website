...
const WhatWeDo = () => {
    ...
    return (
        <div className="w-full h-auto shadow-[0_8px_20px_-4px_rgba(0,0,0,0.2)] rounded-xl bg-gray-100 flex items-center flex-wrap justify-center opacity-80">
            <div
                className={insideDivClass}
                style={{ backgroundColor: "#0000e6" }}
            >
