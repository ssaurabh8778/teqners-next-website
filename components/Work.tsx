...
const Work: React.FC = () => {
    const projectsList = useMemo(
        () => [
            {
                id: 1,
                img: { src: "/project1.png", alt: "Amazing project" },
            ...
            {
                id: 2,
                img: { src: "/project2.png", alt: "Amazing project2" },
            ...
            {
                id: 3,
                img: { src: "/project1.png", alt: "Amazing project3" },
            ...
            {
                id: 4,
                img: { src: "/project2.png", alt: "Amazing project4" },
            ...
            {
                id: 5,
                img: { src: "/project1.png", alt: "Amazing project5" },
            ...
            {
                id: 6,
                img: { src: "/project2.png", alt: "Amazing project5" },
